...
//this is for getting the quantity 
 ...
 <input type="hidden" name="return" value="http://127.0.0.1/main/paypal_success.php">
 <input type="hidden" name="cancel_return" value="http://127.0.0.1/main/paypal_cancel.php">
